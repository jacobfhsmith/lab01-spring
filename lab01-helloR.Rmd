...
subtitle: "due Monday January 10 at 11:59 PM "
output: 
  tufte::tufte_html:
   #css: "./sta199-labs.css"
...
-   Click on this link to accept the assignment: https://classroom.github.com/a/sAMJrIf7
...
![How to Clone using SSH in GitHub](GitHub Example.png)
...
![Version Control and Cloning Repo](GitHub Example2.png)
...
```{r name, eval=FALSE}
library(usethis)
use_git_config(user.name="jacobfhsmith", user.email="jacob.f.smith@duke.edu")
```

## R and R Studio

![These are the general components of a R Markdown File](R Example 1.png)
